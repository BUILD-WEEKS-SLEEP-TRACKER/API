...
describe('SleepLog mode', function(){
    ...
    describe('add() a sleepLog', function(){
        ...
        it('Adds a new entry to the sleep log', async function(){
            ...
            SleepLog.add({date: '03/02/2020', wakeUpRating: 2, dayRating: 2, nightRating: 2, wokeup: "8:30 AM", fellAsleep: "11:00 PM", totalTimeSlept:"8:00", user_id:1})
    ...
    describe('remove() a sleeplog', function(){
        ...
        it('removes an existing entry to the sleep log', async function(){
            ...
            await SleepLog.add({ date: '03/02/2020', wakeUpRating: 2, dayRating: 2, nightRating: 2, wokeup: "8:30 AM", fellAsleep: "11:00 PM", totalTimeSlept:"8:00", user_id:1})
            await  SleepLog.add({ date: '03/03/2020', wakeUpRating: 3, dayRating: 3, nightRating: 3, wokeup: "8:30 AM", fellAsleep: "12:00 PM", totalTimeSlept:"8:30", user_id:1})
    ...
    describe('update() a sleepLog', function(){
        ...
        it('updates an existing entry in the sleep log', async function(){
            ...
            const changes = {date: '03/02/2020', wakeUpRating: 1, dayRating: 1, nightRating: 1, wokeup: "8:30 AM", fellAsleep: "11:00 PM", totalTimeSlept:"8:00", user_id:1}
